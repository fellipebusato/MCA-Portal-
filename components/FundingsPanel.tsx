                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {!isCurrent && !isCompleted && <span className="rounded-full bg-gray-100 border border-gray-200 px-2 py-0.5 text-[10px] font-medium text-gray-400">Queued — starts when current is paid off</span>}
                    </div>
                    {funding.funded_date && (
